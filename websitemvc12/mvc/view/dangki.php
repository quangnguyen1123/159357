...
<head>
	...
	<link rel="stylesheet" href="http://localhost:40/websitemvc12/public/css/dangki1.css">
...
<section class="get-in-touch">
   ...
   <form class="contact-form row" method="POST">
      ...
      <div class="form-field col-lg-6 ">
       ...
       <div class="form-field col-lg-6 ">
         <input id="phone" name = "sodt"class="input-text js-input" type="text" required>
         <label class="label" for="phone">Số điện thoại</label>
      </div>
      <div class="form-field col-lg-6">
         <input id="message" name = "tenuser"class="input-text js-input" type="text" required>
         <label class="label" for="message">Tên người dùng</label>
      </div>
      <div class="form-field col-lg-6">
         <input id="message" name = "tuoi"class="input-text js-input" type="text" required>
